...
echo $template->retrieveSiteStylesheets(ESC_RAW);
?>
<div id="w3s_cms"></div>
...
<?php 
	echo $managerMenu->renderMenuManager('full', ESC_RAW);
	echo $interactiveMenu->renderMenu(ESC_RAW);
  echo $commands->renderMenu(ESC_RAW);
  echo $actions->renderMenu(ESC_RAW);
