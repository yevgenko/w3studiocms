...
class w3sImageEditor extends w3sContentsEditor
{
  ...
  protected function drawProperties()
  {
    ...
    else
    {
  	...
  	$params = 
      array(
        array('name' => 'w3s_ppt_image', 'label' => 'Image', 'type' => 'input', 'options' => array('value' => w3sCommonFunctions::getStdBasename($this->attributes["fullImagePath"], sfConfig::get('app_absolute_images_path')), 'disabled'=> true, 'class' => 'disabled')),
